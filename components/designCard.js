...
export default function Card(props) {
  return (
    <div className="flex flex-col w-3/12 items-center text-center solid-drop-shadow-lg    gap-6 p-4 px-3 hover:bg-yellow outline transition ease-in-out duration-300 outline-2 solid">
